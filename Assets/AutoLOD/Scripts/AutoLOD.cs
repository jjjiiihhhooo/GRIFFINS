...
public class AutoLODWindow : EditorWindow
{
    ...
    void OnGUI()
    {
            ...
            if (targets[i]._foldout)
            {
                ...
                if (subEditor)
                {
                    ...
                    if (targets[i]._customSettings)
                    {
                        ...
                        targets[i]._backend = (AutoLODProperties.MeshDecimatorBackend)EditorGUILayout.EnumPopup("Backend", targets[i]._backend);
                        ...
                        if (targets[i]._backend == AutoLODProperties.MeshDecimatorBackend.Fast)
                        {
        ...
        commonSettings._backend = (AutoLODProperties.MeshDecimatorBackend)EditorGUILayout.EnumPopup("Backend", commonSettings._backend);
        ...
        if (commonSettings._backend == AutoLODProperties.MeshDecimatorBackend.Fast)
        {
    ...
    private void ProcessMeshRenderer(AutoLODProperties properties, int count)
    {
        ...
        {
            case AutoLODProperties.MeshDecimatorBackend.HighQuality:
                meshDecimator = new CQualityMeshDecimator();
                break;

            case AutoLODProperties.MeshDecimatorBackend.Fast:
            default:
