Shader "GapperGames/STINGRAY_Sky" {
    Properties
    {
            ...
            Pass {
                ...
                v2f vert(appdata_t v)
                {
                    ...
                    if (eyeRay.y >= 0.0)
                    {
                        ...
                        float3 sampleRay = eyeRay * sampleLength * float3(1, lerp(1, 2, skyTime), 1);
                    ...
                    else
                    {
                        ...
                        cOut = clamp(attenuate, 0.0, 1.0);
                            ...
                            OUT.skyGroundFactor = -eyeRay.y / SKY_GROUND_THRESHOLD;
                                    ...
                                    OUT.groundColor = (max(dot(_WorldSpaceLightPos0.xyz, float3(0, 1, 0)), 0) * 0.2) + 0.3;
